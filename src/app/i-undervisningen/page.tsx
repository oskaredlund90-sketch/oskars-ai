...
export const metadata: Metadata = {
  title: 'AI i undervisningen | Oskars AI',
  description: 'Konkreta sätt att använda AI i din undervisning. Lektionsplanering, differentiering, elevverktyg och klassrumsaktiviteter.',
}
