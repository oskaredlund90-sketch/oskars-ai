...
export const metadata: Metadata = {
  title: 'Studieteknik & AI | Oskars AI',
  description: 'Hur AI kan stärka elevernas studieteknik med evidensbaserade metoder som retrieval practice, elaboration och spacing.',
}
